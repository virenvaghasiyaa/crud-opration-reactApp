            ...
            <div className='my-5'>
                <div className='container'>
                    <div className='d-flex justify-content-between align-items-center mb-3'>
                        ...
                        <a href="#" className='btn-clickable druk-font d-flex align-items-center' onClick={handleAddUserShow} >
                            <svg width='20' height='20' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" className='me-1'>
                                <g>
                                    <g>
                        ...
                        <Modal.Body>
                            <div className='mb-3'>
                                <form onSubmit={handleAddUser}>
                                    ...
                                    <button type='submit' className='btn btn-clickable druk-font w-100' onClick={handleAddUserClose}>Add user</button>
                                </form>
                            </div>
                        </Modal.Body>
                    </Modal>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className='text-end'>
                                                ...
                                                <Link to='#' className='me-3' onClick={() => { handleEditUserShow(); fetchUser(item.id); }}>
                                                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='edit-icon'>
                                                ...
                                                {/* delete */}
                                                <Link to="#" className='me-4' onClick={() => { handleDeleteUser(item.id); }}>
                                                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='delete-icon'>
                                                        <g id="Iconly/Light/Delete">
                                                            <g id="Delete">
                                                                <path id="Stroke 1" d="M19.3249 9.4682C19.3249 9.4682 18.7819 16.2032 18.4669 19.0402C18.3169 20.3952 17.4799 21.1892 16.1089 21.2142C13.4999 21.2612 10.8879 21.2642 8.27991 21.2092C6.96091 21.1822 6.13791 20.3782 5.99091 19.0472C5.67391 16.1852 5.13391 9.4682 5.13391 9.4682" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                                <path id="Stroke 3" d="M20.7082 6.23969H3.75024" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                                <path id="Stroke 5" d="M17.4407 6.23967C16.6557 6.23967 15.9797 5.68467 15.8257 4.91567L15.5827 3.69967C15.4327 3.13867 14.9247 2.75067 14.3457 2.75067H10.1127C9.5337 2.75067 9.0257 3.13867 8.8757 3.69967L8.6327 4.91567C8.4787 5.68467 7.8027 6.23967 7.0177 6.23967" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                            </g>
                                                        </g>
                                                    </svg>
                                                </Link>
                        ...
                        <Modal.Body>
                            <div>
                                <form onSubmit={handleEditUser}>
                                    ...
                                    <button type='submit' className='btn-clickable druk-font w-100' onClick={handleEditUserClose}>Update user</button>
                                </form>
                            </div>
                        </Modal.Body>
                    </Modal>
